(() => {
  ...
  // src/bs-tags.js
  injectStyles_default("bs-tags", tags_pure_min_default);
  defineEl_default("bs-tags", BsTags_default);
  var bs_tags_default = BsTags_default;
})();
