(() => {
    ...
    "node_modules/intl-tel-input/build/js/intlTelInputWithUtils.js"(exports, module) {
      (function(factory) {
        ...
        var factoryOutput = (() => {
          ...
          var createEl = (name2, attrs, container) => {
            const el = document.createElement(name2);
            if (attrs) {
          ...
          var Iti = class {
            ...
            _initRequests() {
              ...
              if (utilsScript && !intlTelInput2.utils) {
                if (intlTelInput2.documentReady()) {
                  intlTelInput2.loadUtils(utilsScript);
                } else {
                ...
                this._handleKeydownEvent = (e) => {
                  if (e.key && e.key.length === 1 && !e.altKey && !e.ctrlKey && !e.metaKey) {
                    ...
                    if (strictMode) {
                      ...
                      const coreNumber = intlTelInput2.utils.getCoreNumber(fullNumber, this.selectedCountryData.iso2);
            ...
            _trigger(name2, detailProps = {}) {
              const e = new CustomEvent(name2, {
                bubbles: true,
                cancelable: true,
                detail: detailProps
              });
            ...
            _updateMaxLength() {
              ...
              if (strictMode && intlTelInput2.utils) {
                if (this.selectedCountryData.iso2) {
                  ...
                  while (intlTelInput2.utils.isPossibleNumber(exampleNumber, this.selectedCountryData.iso2, validationNumberType)) {
                    validNumber = exampleNumber;
                    exampleNumber += "0";
                  }
                  const coreNumber = intlTelInput2.utils.getCoreNumber(validNumber, this.selectedCountryData.iso2);
            ...
            _utilsIsPossibleNumber(val) {
              return intlTelInput2.utils ? intlTelInput2.utils.isPossibleNumber(val, this.selectedCountryData.iso2, this.options.validationNumberType) : null;
            }
            ...
            _utilsIsValidNumber(val) {
              return intlTelInput2.utils ? intlTelInput2.utils.isValidNumber(val, this.selectedCountryData.iso2) : null;
            }
          ...
          (function() {
            ...
            m2("intlTelInputUtilsTemp", {});
            m2("intlTelInputUtilsTemp.formatNumberAsYouType", (a, b) => {
              try {
            ...
            m2("intlTelInputUtilsTemp.formatNumber", (a, b, c) => {
              try {
            ...
            m2("intlTelInputUtilsTemp.getExampleNumber", (a, b, c, d) => {
              try {
                const l = J.g();
                a: {
                  var e = l;
            ...
            m2("intlTelInputUtilsTemp.getExtension", (a, b) => {
              try {
            ...
            m2("intlTelInputUtilsTemp.getNumberType", (a, b) => {
              try {
            ...
            m2("intlTelInputUtilsTemp.getValidationError", (a, b) => {
              if (!b) return 1;
              try {
            ...
            m2("intlTelInputUtilsTemp.isValidNumber", (a, b) => {
              try {
                const l = J.g();
            ...
            m2("intlTelInputUtilsTemp.isPossibleNumber", (a, b, c) => {
              try {
            ...
            m2("intlTelInputUtilsTemp.getCoreNumber", (a, b) => {
              try {
            ...
            m2("intlTelInputUtilsTemp.numberFormat", { E164: 0, INTERNATIONAL: 1, NATIONAL: 2, RFC3966: 3 });
            m2("intlTelInputUtilsTemp.numberType", Z);
            m2("intlTelInputUtilsTemp.validationError", { IS_POSSIBLE: 0, INVALID_COUNTRY_CODE: 1, TOO_SHORT: 2, TOO_LONG: 3, IS_POSSIBLE_LOCAL_ONLY: 4, INVALID_LENGTH: 5 });
          })();
  ...
  // src/classes/TelInput.js
  var import_intlTelInputWithUtils = __toESM(require_intlTelInputWithUtils());
  ...
  // src/classes/TelInput.js
  var name = "tel-input";
  var TelInput = class extends EventfulElement_default {
    /**
    ...
    created() {
      ...
      this.config = Object.assign(
        {
          ...
          i18n: localeProvider_default(name) || {},
      ...
      if (this.config.initialCountry == "auto" && !this.config.geoIpLookup) {
        this.config.geoIpLookup = (callback) => {
          ...
          const result = Storage_default.get("ipapi");
          if (result) {
            callback(result[field]);
            return;
          }
          fetchJson_default("https://ipapi.co/json").then((data) => {
            Storage_default.set("ipapi", data);
            callback(data[field]);
          }).catch(() => callback("us"));
        };
      }
      this.iti = (0, import_intlTelInputWithUtils.default)(input, this.config);
  ...
  injectStyles_default("tel-input", `${tel_input_min_default}
${extraStyles}`);
  defineEl_default("tel-input", TelInput_default);
  var tel_input_default = TelInput_default;
})();
