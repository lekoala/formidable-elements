...
`;function rt(n,r){if(!document.head.querySelector(`#${n}-style`)){let e=document.createElement("style");e.id=`${n}-style`,e.innerText=r,document.head.append(e)}}var Fn=`input.flatpickr-input.form-control[readonly] {
    background-color: var(--bs-body-bg, #fff);
    border-color: var(--bs-border-color, #dee2e6);
}`;rt("flatpickr-input",Lt+Ht+jt+Fn);at("flatpickr-input",nt);var Aa=nt;})();
