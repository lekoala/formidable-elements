...
`;var Ht=`.flatpickr-monthSelect-months {
...
`;var jt=(n,r)=>{if(!document.head.querySelector(`#${n}-style`)){let e=document.createElement("style");e.id=`${n}-style`,e.innerText=r,document.head.append(e)}};var Fn=`input.flatpickr-input.form-control[readonly] {
    background-color: var(--bs-body-bg, #fff);
    border-color: var(--bs-border-color, #dee2e6);
}`;jt("flatpickr-input",Rt+Lt+Ht+Fn);Nt("flatpickr-input",Ze);var Aa=Ze;})();
