...
`;Ot(re,Je);function ae(t,i,e){if(!t||!i)return;let n=window.getComputedStyle(t),s=window.getComputedStyle(i),o=window.getComputedStyle(e);t.dataset.defaultPadding||(t.dataset.defaultPadding=n.paddingTop),e.dataset.defaultPadding||(e.dataset.defaultPadding=o.paddingTop),i.style.top=`${n.borderTopWidth}`,i.style.left=`${n.borderLeftWidth}`,i.style.right=`${n.borderRightWidth}`,i.style.borderTopLeftRadius=`${n.borderRadius}`,i.style.borderTopRightRadius=`${n.borderRadius}`,t.style.paddingTop=`calc(${t.dataset.defaultPadding} + ${s.height})`,e.style.paddingTop=`calc(${e.dataset.defaultPadding} + ${s.height})`}var oe=new ResizeObserver(t=>{for(let i of t){let e=i.target.offsetWidth;if(e!=i.target.dataset.width&&(i.target.dataset.width=e,i.contentBoxSize)){let n=i.target.querySelector("textarea"),s=i.target.querySelector(".squire-input"),o=i.target.querySelector(".squire-toolbar");ae(s,o,n)}}}),pt=class extends ne{get el(){return this.querySelector("textarea")}created(){if(!this.el){let i=R("textarea");i.name=ft(this,"name"),i.value=ft(this,"value"),ut()&&i.classList.add("form-control"),this.appendChild(i)}this.el.setAttribute("hidden",""),this.el.style.overflow="hidden",this.el.spellcheck=!1,this.init()}async init(){await se();let i=this.querySelector(".squire-toolbar"),e=this.querySelector(".squire-input");if(i&&i.remove(),e&&e.remove(),!this.dataset.toolbar){i=R("div"),i.classList.add("squire-toolbar"),this.appendChild(i);let o=[[{name:"bold",action:"bold",format:"b",removeAction:"removeBold",icon:`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
          ...
          </svg>`}]],r=this.dataset.buttons?this.dataset.buttons.split(","):[],a=(l,c=i)=>{if(r.length&&!r.includes(l.name))return;let d=R("button");d.type="button",d.innerHTML=l.icon,d.dataset.action=l.action,d.dataset.removeAction=l.removeAction,d.dataset.format=l.format,d.dataset.prompt=l.prompt||"",c.appendChild(d)};o.forEach(l=>{if(Array.isArray(l)){let c=R("div");c.classList.add("squire-toolbar-group"),i.appendChild(c),l.forEach(d=>a(d,c))}else a(l)})}e=R("div"),e.classList.add("squire-input"),ut()&&e.classList.add("form-control"),this.appendChild(e);let s=this.el;ae(e,i,s),this.config=Object.assign({blockTag:"div",blockAttributes:{class:"paragraph"},tagAttributes:{blockquote:{class:"blockquote"}},sanitizeToDOMFragment:(o,r)=>{let a=R("div");yt(a,o);let l=At(a.innerHTML);return l?document.importNode(l,!0):document.createDocumentFragment()}},this.config),this.editor=new ie(e,this.config),this.editor.setHTML(s.value),this.editor.addEventListener("input",()=>{let o=this.editor.getHTML();this.el.value=o})}connected(){this.addEventListener("click",this),this.addEventListener("input",this),oe.observe(this)}disconnected(){this.removeEventListener("click",this),this.removeEventListener("input",this),oe.unobserve(this)}handleEvent(i){this[`_${i.type}`](i)}_undoStateChange(i){this._input(i)}_input(i){i.target===this.el&&(this.el.style.height="0",this.el.style.height=this.el.scrollHeight+"px")}_click(i){let e=i.target.closest("button");if(!e)return;let n=this.editor,s=e.dataset.action,o=e.dataset.removeAction,r=e.dataset.format,a=e.dataset.prompt,l,c;if(s==="html"){let d=this.querySelector(".squire-input"),h=this.querySelector("textarea");if(h.hasAttribute("hidden")){let f=Math.max(parseInt(window.getComputedStyle(d).height),h.scrollHeight);h.style.height=f+"px",d.setAttribute("hidden",""),h.removeAttribute("hidden")}else this.editor.setHTML(h.value),h.setAttribute("hidden",""),d.removeAttribute("hidden");return}if(s&&n&&n[s]){let d=n.getSelection();if(r&&o&&n.hasFormat(r))o==="changeFormat"&&(l=null,c={tag:r}),n[o](l,c);else{if(a){if(d.collapsed)return;if(l=window.prompt(),!l){n[o](l,c);return}}s==="changeFormat"&&(l={tag:r}),n[s](l,c)}}}destroyed(){this.editor.destroy(),this.editor=null}};customElements.define(re,pt);var Ti=pt;})();
