...
`;Ot(re,Je);function ae(t,i,e){if(!t||!i)return;let n=window.getComputedStyle(t),s=window.getComputedStyle(i),o=window.getComputedStyle(e);t.dataset.defaultPadding||(t.dataset.defaultPadding=n.paddingTop),e.dataset.defaultPadding||(e.dataset.defaultPadding=o.paddingTop),i.style.top=`${n.borderTopWidth}`,i.style.left=`${n.borderLeftWidth}`,i.style.right=`${n.borderRightWidth}`,i.style.borderTopLeftRadius=`${n.borderRadius}`,i.style.borderTopRightRadius=`${n.borderRadius}`,t.style.paddingTop=`calc(${t.dataset.defaultPadding} + ${s.height})`,e.style.paddingTop=`calc(${e.dataset.defaultPadding} + ${s.height})`}var oe=new ResizeObserver(t=>{for(let i of t){let e=i.target,n=e.offsetWidth.toString();if(n!=e.dataset.width&&(e.dataset.width=n,i.contentBoxSize)){let s=U("textarea",null,e),o=U("div",".squire-input",e),r=U("div",".squire-toolbar",e);ae(o,r,s)}}}),pt=class extends ie{get el(){return U("textarea",null,this)}created(){if(!this.el){let e=R("textarea",{name:this.getAttribute("name"),value:this.getAttribute("value")});ut()&&e.classList.add("form-control"),this.appendChild(e)}this.classList.add("squire-editor");let i=this.el;i.setAttribute("hidden",""),i.style.overflow="hidden",i.spellcheck=!1,this.init()}async init(){await ne(se);let i=U("div",".squire-toolbar",this),e=U("div",".squire-input",this);if(i&&i.remove(),e&&e.remove(),!this.dataset.toolbar){i=R("div"),i.classList.add("squire-toolbar"),this.appendChild(i);let o=[[{name:"bold",action:"bold",format:"b",removeAction:"removeBold",icon:`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
